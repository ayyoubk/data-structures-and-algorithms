...
const addOne = (arr) => {
  // Solution code here...
  const addOneArr = arr.map((num) =>num+1);
  return addOneArr;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  const addQuestionArr = arr.map((element) =>element+'?');
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const resultsArr = arr.map((element) => Math.pow(2, element));
  return resultsArr;
};
...
const charCode = (arr) => {
  // Solution code here...
  const resultsArr = arr.map(item => item.charCodeAt());
  return resultsArr;
};
...
const evenOdd = (arr) => {
  // Solution code here...
  const resultsArr = arr.map(element => {
    if (isNaN(element)) {
      return 'N/A';
    } else if (element % 2 === 0) {
      return 'even';
...
const extractAbilities = (arr) => {
  // Solution code here...
  const resultsArr = arr.map(element => element.ability.name);
  return resultsArr;
};
...
const extractStats = (arr) => {
  ...
  const resultsArr = arr.map(element => {
    const newOpj={};
    newOpj['name']= element.stat.name;
    newOpj['total']= element.effort + element.baseStat;
    return newOpj;
  });
  return resultsArr;
};
